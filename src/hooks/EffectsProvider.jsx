...
export const EffectsProvider = ({ children }) => {
  ...
  const handleCompressor = ({ target }, id) => {
    ...
    if (prop === 'bypass') {
      ...
      effectToUpdate.settings = { ...effectToUpdate.settings, [prop]: !effectToUpdate.settings.automakeup };
      setNewEffectSettings([...oldEffects, effectToUpdate]);
    } else {
      effectToUpdate.settings = { ...effectToUpdate.settings, [prop]: target.value };
      setNewEffectSettings([...oldEffects, effectToUpdate]);
  ...
  const handleWahWah = ({ target }, id) => {
    ...
    if (prop === 'bypass') {
      ...
      effectToUpdate.settings = { ...effectToUpdate.settings, [prop]: !effectToUpdate.settings.automode };
      setNewEffectSettings([...oldEffects, effectToUpdate]);
    } else {
      effectToUpdate.settings = { ...effectToUpdate.settings, [prop]: target.value };
      setNewEffectSettings([...oldEffects, effectToUpdate]);
